...
public:
    ...
    void setupUi(QMainWindow *DentistProjectV2Class)
    {
        ...
        EulerXText = new QLabel(EulerAngleBox);
        EulerXText->setObjectName(QStringLiteral("EulerXText"));
        EulerXText->setGeometry(QRect(10, 20, 21, 16));
        EulerYText = new QLabel(EulerAngleBox);
        EulerYText->setObjectName(QStringLiteral("EulerYText"));
        EulerYText->setGeometry(QRect(10, 50, 21, 16));
        EulerZText = new QLabel(EulerAngleBox);
        EulerZText->setObjectName(QStringLiteral("EulerZText"));
        EulerZText->setGeometry(QRect(10, 80, 21, 16));
        EulerBarX = new QSlider(EulerAngleBox);
        EulerBarX->setObjectName(QStringLiteral("EulerBarX"));
        EulerBarX->setGeometry(QRect(30, 20, 251, 22));
        EulerBarX->setMaximum(359);
        EulerBarX->setValue(0);
        EulerBarX->setOrientation(Qt::Horizontal);
        EulerBarY = new QSlider(EulerAngleBox);
        EulerBarY->setObjectName(QStringLiteral("EulerBarY"));
        EulerBarY->setGeometry(QRect(30, 50, 251, 22));
        EulerBarY->setMaximum(359);
        EulerBarY->setValue(0);
        EulerBarY->setOrientation(Qt::Horizontal);
        EulerBarZ = new QSlider(EulerAngleBox);
        EulerBarZ->setObjectName(QStringLiteral("EulerBarZ"));
        EulerBarZ->setGeometry(QRect(30, 80, 251, 22));
        EulerBarZ->setMaximum(359);
        EulerBarZ->setValue(0);
        EulerBarZ->setOrientation(Qt::Horizontal);
        EulerZValueText = new QLabel(EulerAngleBox);
        EulerZValueText->setObjectName(QStringLiteral("EulerZValueText"));
        EulerZValueText->setGeometry(QRect(290, 80, 21, 16));
        EulerZValueText->setAlignment(Qt::AlignCenter);
        EulerYValueText = new QLabel(EulerAngleBox);
        EulerYValueText->setObjectName(QStringLiteral("EulerYValueText"));
        EulerYValueText->setGeometry(QRect(290, 50, 21, 16));
        EulerYValueText->setAlignment(Qt::AlignCenter);
        EulerXValueText = new QLabel(EulerAngleBox);
        EulerXValueText->setObjectName(QStringLiteral("EulerXValueText"));
        EulerXValueText->setGeometry(QRect(290, 20, 21, 16));
        EulerXValueText->setAlignment(Qt::AlignCenter);
...
"(End)", nullptr));
        ...
        EulerXText->setText(QApplication::translate("DentistProjectV2Class", "X", nullptr));
        EulerYText->setText(QApplication::translate("DentistProjectV2Class", "Y", nullptr));
        EulerZText->setText(QApplication::translate("DentistProjectV2Class", "Z", nullptr));
