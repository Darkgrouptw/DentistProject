...
public:
    ...
    QLabel *QuaternionXText;
    QLabel *QuaternionYText;
    QLineEdit *QuaternionYValue;
    QLabel *QuaternionZText;
    QLineEdit *QuaternionWValue;
    QLabel *QuaternionWText;
    QLineEdit *QuaternionXValue;
    QLineEdit *QuaternionZValue;
    QGroupBox *EulerAngleBox;
    QLabel *EularXText;
    QLabel *EularYText;
    QLabel *EularZText;
    QSlider *EularBarX;
    ...
    QSlider *EularBarZ;
    QLabel *EularZText_2;
    QLabel *EularYValueText;
    QLabel *EularXValueText;
    QComboBox *PCIndex;
    ...
    void setupUi(QMainWindow *DentistProjectV2Class)
    {
        ...
        pushButton = new QPushButton(AlignBox);
        ...
        QuaternionBox = new QGroupBox(PCInfoBox);
        QuaternionBox->setObjectName(QStringLiteral("QuaternionBox"));
        QuaternionBox->setGeometry(QRect(10, 50, 161, 141));
        QuaternionXText = new QLabel(QuaternionBox);
        QuaternionXText->setObjectName(QStringLiteral("QuaternionXText"));
        QuaternionXText->setGeometry(QRect(10, 20, 21, 16));
        QuaternionYText = new QLabel(QuaternionBox);
        QuaternionYText->setObjectName(QStringLiteral("QuaternionYText"));
        QuaternionYText->setGeometry(QRect(10, 50, 21, 16));
        QuaternionYValue = new QLineEdit(QuaternionBox);
        QuaternionYValue->setObjectName(QStringLiteral("QuaternionYValue"));
        QuaternionYValue->setGeometry(QRect(40, 50, 113, 20));
        QuaternionZText = new QLabel(QuaternionBox);
        QuaternionZText->setObjectName(QStringLiteral("QuaternionZText"));
        QuaternionZText->setGeometry(QRect(10, 80, 21, 16));
        QuaternionWValue = new QLineEdit(QuaternionBox);
        QuaternionWValue->setObjectName(QStringLiteral("QuaternionWValue"));
        QuaternionWValue->setGeometry(QRect(40, 110, 113, 20));
        QuaternionWText = new QLabel(QuaternionBox);
        QuaternionWText->setObjectName(QStringLiteral("QuaternionWText"));
        QuaternionWText->setGeometry(QRect(10, 110, 21, 16));
        QuaternionXValue = new QLineEdit(QuaternionBox);
        QuaternionXValue->setObjectName(QStringLiteral("QuaternionXValue"));
        QuaternionXValue->setGeometry(QRect(40, 20, 113, 20));
        QuaternionZValue = new QLineEdit(QuaternionBox);
        QuaternionZValue->setObjectName(QStringLiteral("QuaternionZValue"));
        QuaternionZValue->setGeometry(QRect(40, 80, 113, 20));
        EulerAngleBox = new QGroupBox(PCInfoBox);
        EulerAngleBox->setObjectName(QStringLiteral("EulerAngleBox"));
        EulerAngleBox->setGeometry(QRect(180, 50, 331, 111));
        EularXText = new QLabel(EulerAngleBox);
        EularXText->setObjectName(QStringLiteral("EularXText"));
        EularXText->setGeometry(QRect(10, 20, 21, 16));
        EularYText = new QLabel(EulerAngleBox);
        EularYText->setObjectName(QStringLiteral("EularYText"));
        EularYText->setGeometry(QRect(10, 50, 21, 16));
        EularZText = new QLabel(EulerAngleBox);
        EularZText->setObjectName(QStringLiteral("EularZText"));
        EularZText->setGeometry(QRect(10, 80, 21, 16));
        EularBarX = new QSlider(EulerAngleBox);
        EularBarX->setObjectName(QStringLiteral("EularBarX"));
        EularBarX->setGeometry(QRect(30, 20, 251, 22));
        EularBarX->setMaximum(359);
        EularBarX->setValue(0);
        EularBarX->setOrientation(Qt::Horizontal);
        EularBarY = new QSlider(EulerAngleBox);
        EularBarY->setObjectName(QStringLiteral("EularBarY"));
        EularBarY->setGeometry(QRect(30, 50, 251, 22));
        EularBarY->setMaximum(359);
        EularBarY->setValue(0);
        EularBarY->setOrientation(Qt::Horizontal);
        EularBarZ = new QSlider(EulerAngleBox);
        EularBarZ->setObjectName(QStringLiteral("EularBarZ"));
        EularBarZ->setGeometry(QRect(30, 80, 251, 22));
        EularBarZ->setMaximum(359);
        EularBarZ->setValue(0);
        EularBarZ->setOrientation(Qt::Horizontal);
        EularZText_2 = new QLabel(EulerAngleBox);
        EularZText_2->setObjectName(QStringLiteral("EularZText_2"));
        EularZText_2->setGeometry(QRect(290, 80, 21, 16));
        EularZText_2->setAlignment(Qt::AlignCenter);
        EularYValueText = new QLabel(EulerAngleBox);
        EularYValueText->setObjectName(QStringLiteral("EularYValueText"));
        EularYValueText->setGeometry(QRect(290, 50, 21, 16));
        EularYValueText->setAlignment(Qt::AlignCenter);
        EularXValueText = new QLabel(EulerAngleBox);
        EularXValueText->setObjectName(QStringLiteral("EularXValueText"));
        EularXValueText->setGeometry(QRect(290, 20, 21, 16));
        EularXValueText->setAlignment(Qt::AlignCenter);
...
"(End)", nullptr));
        ...
        pushButton->setText(QApplication::translate("DentistProjectV2Class", "\346\213\274\346\216\245\345\211\215\345\205\251\347\211\207\351\273\236\351\233\262", nullptr));
        ...
        QuaternionXText->setText(QApplication::translate("DentistProjectV2Class", "X", nullptr));
        QuaternionYText->setText(QApplication::translate("DentistProjectV2Class", "Y", nullptr));
        QuaternionZText->setText(QApplication::translate("DentistProjectV2Class", "Z", nullptr));
        QuaternionWText->setText(QApplication::translate("DentistProjectV2Class", "W", nullptr));
        EulerAngleBox->setTitle(QApplication::translate("DentistProjectV2Class", "Euler\350\247\222\345\272\246\347\233\270\351\227\234", nullptr));
        EularXText->setText(QApplication::translate("DentistProjectV2Class", "X", nullptr));
        EularYText->setText(QApplication::translate("DentistProjectV2Class", "Y", nullptr));
        EularZText->setText(QApplication::translate("DentistProjectV2Class", "Z", nullptr));
        EularZText_2->setText(QApplication::translate("DentistProjectV2Class", "0", nullptr));
        EularYValueText->setText(QApplication::translate("DentistProjectV2Class", "0", nullptr));
        EularXValueText->setText(QApplication::translate("DentistProjectV2Class", "0", nullptr));
