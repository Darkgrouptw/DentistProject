...
__global__ static void gpuComputePXScale(double* out, int size_Z)
{
	...
	//z = 2.2512322 + 0.3954103 * x1 - 0.000011 * (x1 - 997.111) ^ 2 - 0.000000010542 * (x1 - 997.111) ^ 3 - 0.000000000005322 * (x1 - 997.111) ^ 4 - 0.000000000000001312 * (x1 - 997.111) ^ 5 + 2.984E-18 * (x1 - 997.111) ^ 6
	//double x1 = 1;
